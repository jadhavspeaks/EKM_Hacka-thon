...
async def run_sync(source_type: SourceType | None = None, force_full: bool = False,
                   spaces_override: list[str] | None = None,
                   projects_override: list[str] | None = None) -> dict:
    """
    ...
    for src in sources_to_sync:
        ...
        try:
            ...
            # Pass kwargs based on what the connector accepts
            import inspect
