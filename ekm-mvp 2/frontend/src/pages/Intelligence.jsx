    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <div>
            <h2 className="text-base font-bold text-slate-900">Knowledge Corpus</h2>
            ...
            {sources.map(s => {
              ...
              return (
                <div key={s.source_type} className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs font-semibold text-slate-900" style={{fontFamily:"'DM Mono',monospace"}}>
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <div>
            <h2 className="text-base font-bold text-slate-900">Search Activity</h2>
