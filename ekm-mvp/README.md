...
<img src="https://img.shields.io/badge/Status-MVP_v3.0-0D9488?style=for-the-badge"/>
...
ekm-mvp/
├── docs/
│   ├── EKM-Executive-Deck-v3.0.pptx      ← Executive presentation (16 slides)
│   ├── EKM-Business-Architecture.pptx    ← Business arch: stakeholders, value streams, outcomes
│   ├── EKM-Technical-Architecture.pptx   ← Technical arch: layered swim-lanes, stack, deployment
│   ├── EKM-Architecture.pptx             ← System component/data-flow diagram
│   ├── build-arch-layers.js              ← Regenerate business + technical diagrams
│   ├── build-system-arch.js              ← Regenerate system component diagram
│   └── architecture.png                  ← Legacy PNG reference
├── backend/
...
<div align="center">
Built as an enterprise MVP · Python + FastAPI + React + MongoDB · v3.0 · March 2026
</div>
